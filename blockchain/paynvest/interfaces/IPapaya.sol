...
interface IPapaya {
    ...
    event StreamCreated(address indexed user, address indexed author, uint256 indexed encodedRates, uint32 streamStarts);
    event StreamRevoked(address indexed user, address indexed author, uint256 indexed encodedRates, uint32 streamDeadline);
    ...
    function subscribe(address author, uint96 subscriptionRate, uint32 projectId) external;
