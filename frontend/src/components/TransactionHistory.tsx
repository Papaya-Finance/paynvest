...
export function   TransactionHistory({ transactions }: TransactionHistoryProps) {
  ...
  const getStatusBadge = (status: Transaction['status']) => {
    ...
    const colors = {
      ...
      confirmed: 'text-primary bg-purple-200 dark:bg-purple-900/30',
                ...
                <TableRow key={transaction.id}>
                  ...
                  <TableCell>
                    <button
                      ...
                      className="inline-flex items-center text-xs text-purple-600 hover:text-purple-800 dark:text-purple-400 dark:hover:text-purple-300 font-mono"
